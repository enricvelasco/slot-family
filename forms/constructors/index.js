...
import {setConstructorImage} from "../../firebase/data/constructors";

const ConstructorsForm = ({ onSubmit, data }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <Link href='/constructors'><button>Cancelar</button></Link>
      </div>
    </form>
  )
}

export default ConstructorsForm
