...
import {setManufacturerImage} from "../../firebase/data/manufacturers";

const ManufacturersForm = ({ onSubmit, data }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <Link href={'/manufacturers'}><button>Cancelar</button></Link>
      </div>
    </form>
  )
}
